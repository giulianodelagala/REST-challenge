/*
  ...
  - Added the required column `publishingType` to the `LikePost` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "publishingType" "PublishingType" NOT NULL;
